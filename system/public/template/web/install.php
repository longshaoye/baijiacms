...
<link
	href="<?php echo RESOURCE_ROOT;?>/addons/public/install/install.css?x=20150530_23"
	rel="stylesheet" />
		...
		<form id="mainForm" action="" method="post">
			<div id="sheets" class="sheet shown">
				<div id="sheet_license" class="sheet shown clearfix">
					...
					<noscript>
						<h4 class="errorBlock" style="margin-bottom: 10px">您需要在浏览器中启用
							JavaScript 来安装</h4>
					</noscript>
					<!-- License agreement -->
					<h2 id="licenses-agreement">许可协议</h2>
					<p>
						<strong>请阅读下面的许可条款。</strong>
					</p>
					<div
						style="height: 200px; border: 1px solid #ccc; margin-bottom: 8px; padding: 5px; background: #fff; overflow: auto; overflow-x: hidden; overflow-y: scroll;">
						...
						<p>4．
							如果再发布的产品中包含一个Notice文件，则在Notice文件中需要带有本协议内容。你可以在Notice中增加自己的许可，但不可以表现为对Apache
							Licence构成更改。</p>
					...
					<div>
						<input type="checkbox" id="set_license" class="required"
							name="licence_agrement" value="1"
							style="vertical-align: middle; float: left" />
						<div style="float: left; width: 600px; margin-left: 8px">
							<label for="set_license"><strong>我同意上述条款和条件。</strong></label>
						</div>
					</div>
			...
			<div id="buttons">
				<input id="btNext" class="button little" type="button"
					onClick="location.href='<?php echo web_url("install",array("name"=>"public","op"=>"setp2"))?>';"
					name="submitNext" value="下一个" style="float: left" />
...
<div id="container">
		...
		<div id="leftpannel">
			<ol id="tabs">
				<li></li>
				<li class="finished"><a
					href="<?php echo web_url("install",array("name"=>"public"))?>">许可协议</a></li>
		...
		<?php echo $resultarray['curl_init']; ?></div>
			...
			<div id="buttons">				
        	   <?php if( $allcheck){?>
               <input id="btNext" class="button little" type="button" onClick="location.href='<?php echo web_url("install",array("name"=>"public","op"=>"setp3"))?>';"
        					name="submitNext" value="下一个" style="float: left" /><?php }else{?><br />
...
<div id="container">
			...
			<form id="mainForm" method="post">
					...
					<div id="sheet_database" class="sheet shown clearfix">
						...
						<noscript>
							<h4 class="errorBlock" style="margin-bottom: 10px">
								您需要在浏览器中启用 JavaScript 来安装 PrestaShop。 <a
									href="http://enable-javascript.com/" target="_blank"> <img
									src="theme/img/help.png" style="height: 16px; width: 16px" />
								</a>
							</h4>
						</noscript>
						...
						<div id="dbPart">
							...
							<div id="formCheckSQL">
								<p class="first" style="margin-top: 15px;">
									<label for="adminname">商城登录账户 </label> <input name="adminname"
										type="text" class="text" id="adminname" value="" />
								</p>
								<p class="first" style="margin-top: 15px;">
									<label for="adminpwd">登录密码 </label> <input name="adminpwd"
										type="text" class="text" id="adminpwd" value="" />
								</p>
								<h2>填写以下字段配置数据库</h2>
								<p class="first" style="margin-top: 15px;">
									<label for="dbhost">数据库服务器地址 </label> <input name="dbhost"
										type="text" class="text" id="dbhost" value="" />
								</p>
								<p class="first" style="margin-top: 15px;">
									<label for="dbport">数据库服务器端口 </label> <input size="10"
										class="text" type="text" id="dbport" name="dbport"
										value="3306" /> <span class="userInfos aligned">默认端口为3306。</span>
								</p>
								<p>
									<label for="dbName">数据库名称 </label> <input size="10"
										class="text" type="text" id="dbname" name="dbname"
										value="baijiacms" />
								</p>
								<p>
									<label for="dbuser">数据库登录名 </label> <input class="text"
										size="10" type="text" id="dbuser" name="dbuser" value="root" />
								</p>
								<p>
									<label for="dbpwd">数据库密码 </label> <input class="text" size="10"
										type="text" id="dbpwd" name="dbpwd" value="" />
								</p>
				...
				<div id="buttons">
					<input name="doact" type="hidden" value="install" /> <input
						id="btNext" class="button little" type="submit" name="submitNext"
						value="下一个" />
