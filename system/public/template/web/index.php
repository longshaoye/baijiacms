...
<meta name="description"
	content="<?php  echo empty($settings['shop_description'])?'':$settings['shop_description'];?>" />
<meta name="keywords"
	content="<?php  echo empty($settings['shop_keyword'])?'':$settings['shop_keyword'];?>">
<link rel="stylesheet"
	href="<?php echo RESOURCE_ROOT;?>/addons/public/component-min.css">
<link rel="stylesheet"
	href="<?php echo RESOURCE_ROOT;?>/addons/public/jbox-min.css">
<link rel="stylesheet"
	href="<?php echo RESOURCE_ROOT;?>/addons/public/common_login_reg.css">
...
<body>
		...
		<div class="login">
			...
			<div class="login-inner">
				...
				<div class="login-item mgb20">
					<input type="text" class="clearError" name="username"
						id="ipt_account" placeholder="请输入登录账号" tabindex="1"> <a
						href="javascript:;" class="clearIpt j-clearIpt"><i
						class="gicon-remove"></i></a>
				</div>
				<div class="login-item mgb20">
					<input type="password" class="clearError" name="password"
						id="ipt_pwd" placeholder="请输入密码" tabindex="2"> <a
						href="javascript:;" class="clearIpt j-clearIpt"><i
						class="gicon-remove"></i></a>
				</div>
				<div class="login-item mgb20">
					<input type="text" class="clearError" name="verify" id="ipt_code"
						placeholder="验证码" data-autohide="1" tabindex="3"> <a
						href="javascript:;" class="clearIpt j-clearIpt"><i
						class="gicon-remove"></i></a>
				</div>
				<div class="mgb20">
					<img id="verifyimg" onClick="fleshVerify()" alt="点击切换"
						src="<?php  echo web_url('verify',array('name'=>'public'))?>"
						style="cursor: pointer; width: 265px; height: 70px" />
				</div>
	...
	<script
		src="<?php echo RESOURCE_ROOT;?>/addons/public/jquery.jbox-min.js"></script>
	<script
		src="<?php echo RESOURCE_ROOT;?>/addons/public/component-min.js"></script>
	<script
		src="<?php echo RESOURCE_ROOT;?>/addons/public/common_login_reg.js"></script>
	<!--[if lt IE 10]>
